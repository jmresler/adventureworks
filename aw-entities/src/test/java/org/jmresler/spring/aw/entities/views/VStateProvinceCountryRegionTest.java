...
public class VStateProvinceCountryRegionTest {
	...
	public void test() {
		try {
			TypedQuery<VStateProvinceCountryRegion> candQuery = manager.createNamedQuery("VStateProvinceCountryRegion.findAll", VStateProvinceCountryRegion.class);
