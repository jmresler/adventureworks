...
public class VProductModelInstructionsTest {
	...
	public void test() {
		try {
			TypedQuery<VProductModelInstructions> candQuery = manager.createNamedQuery("VProductModelInstructions.findAll", VProductModelInstructions.class);
