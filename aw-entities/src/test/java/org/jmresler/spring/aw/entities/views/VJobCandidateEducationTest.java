...
public class VJobCandidateEducationTest {
	...
	public void test() {
		try {
			TypedQuery<VJobCandidateEducation> candQuery = manager.createNamedQuery("VJobCandidateEducation.findAll", VJobCandidateEducation.class);
