...
public class VProductAndDescriptionTest {
	...
	public void test() {
		try {
			TypedQuery<VProductAndDescription> candQuery = manager.createNamedQuery("VProductAndDescription.findAll", VProductAndDescription.class);
