...
public class VVendorWithAddressesTest {
	...
	public void test() {
		try {
			TypedQuery<VVendorWithAddresses> candQuery = manager.createNamedQuery("VVendorWithAddresses.findAll", VVendorWithAddresses.class);
