...
public class VPersonDemographicsTest {
	...
	public void test() {
		try {
			TypedQuery<VPersonDemographics> candQuery = manager.createNamedQuery("VPersonDemographics.findAll", VPersonDemographics.class);
