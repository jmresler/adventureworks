...
public class VStoreWithDemographicsTest {
	...
	public void test() {
		try {
			TypedQuery<VStoreWithDemographics> candQuery = manager.createNamedQuery("VStoreWithDemographics.findAll", VStoreWithDemographics.class);
