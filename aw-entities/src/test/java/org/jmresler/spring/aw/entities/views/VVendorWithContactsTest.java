...
public class VVendorWithContactsTest {
	...
	public void test() {
		try {
			TypedQuery<VVendorWithContacts> candQuery = manager.createNamedQuery("VVendorWithContacts.findAll", VVendorWithContacts.class);
