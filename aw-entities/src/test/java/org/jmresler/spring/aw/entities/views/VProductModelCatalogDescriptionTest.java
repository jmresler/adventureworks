...
public class VProductModelCatalogDescriptionTest {
	...
	public void test() {
		try {
			TypedQuery<VProductModelCatalogDescription> candQuery = manager.createNamedQuery("VProductModelCatalogDescription.findAll", VProductModelCatalogDescription.class);
